shots_per_point = 6;
freq = [100:4:140];
marker = mod(floor((i-1)/shots_per_point)+1,length(freq)); %Counts from 1 to num shots before setpt update


% file = 'C:\Remote\settings202021Jul105753.xml';
file = 'c:\remote\settings202130Apr135234.xml'; 
%'c:\remote\settings202117Mar100852.xml'; 
% 'c:\remote\settings202117Mar100624.xml';%'c:\remote\settings202116Mar150002.xml';%'c:\remote\settings202111Mar100454.xml';
% c:\remote\settings202117Mar092334.xml
...
fprintf(f_log,[num2str(i),',',datestr(datetime,'yyyymmdd_HHMMSS'),',',low_time_str,',',num2str(freq(marker)),'\n']);
fclose(f_log);